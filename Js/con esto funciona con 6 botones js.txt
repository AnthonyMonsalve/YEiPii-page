    ...
    if (window.matchMedia("(min-width: 1054px)").matches) {
        ...
        if (Universidades.style.opacity == .6) {
            for (let index = 0; index < 6; index++) {
                ...
                categoryBox[index].classList.remove('categoryOpen-2filas');
                categoryBox[index].classList.remove('categoryOpen-2filas-abajo');
        ...
        var cuantasFilas = Math.ceil(Circulos.length / 3);
        let heightBox = (170 * cuantasFilas) + 30 + 'px';
        let marginBox = (170 * cuantasFilas) + 30 + 30 + 'px';
...
Discotecas.onclick = function () {
    ...
    if (window.matchMedia("(min-width: 1054px)").matches) {
        ...
        let heightBox = (170 * cuantasFilas) + 60 + 'px';
        let marginBox = (170 * cuantasFilas) + 60 + 30 + 'px';
